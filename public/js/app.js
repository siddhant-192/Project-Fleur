...
var addToCart = document.querySelectorAll('.item-button');
function updateCart(appetizer) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/update-cart', appetizer).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    console.log(e);
    var appetizer = JSON.parse(btn.dataset.appetizers);
